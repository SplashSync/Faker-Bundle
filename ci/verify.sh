...
# PHP 7.2
echo '===> Checks Php 7.2'
docker-compose exec php-7.2 composer update
...
# PHP 7.3
echo '===> Checks Php 7.3'
docker-compose exec php-7.3 composer update
...
# PHP 7.4
echo '===> Checks Php 7.4'
docker-compose exec php-7.4 composer update
...
# PHP 8.0
echo '===> Checks Php 8.0'
docker-compose exec php-8.0 composer update
